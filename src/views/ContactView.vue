  ...
  <div class="flex flex-col justify-center items-center w-full lg:mb-8 bg-stone-50 pb-8">
    ...
    <div class="flex flex-col justify-center w-full md:flex-row md:space-x-24 space-y-10 md:space-y-0">
      <div v-if="!success" class="flex flex-col justify-center w-full lg:w-4/12">
        ...
        <form ref="enquiryForm" @submit.prevent="formSubmit()"
          class="p-8 flex flex-col justify-center text-left bg-blue-400 rounded-lg shadow-lg">
          <!-- loading spinner ends -->
          <label class="flex flex-col text-white font-bold text-lg" for="first-name">First Name:
            <input class="p-3 rounded-lg text-gray-900" type="text" name="first-name" v-model="firstName"
              placeholder="please enter you first name" required>
          </label>

          <label class="flex flex-col text-white font-bold text-lg" for="last-name">Last Name:
            <input class="p-3 rounded-lg text-gray-900" type="text" name="last-name" v-model="lastName"
              placeholder="please enter you last name" required>
          </label>

          <label class="flex flex-col text-white font-bold text-lg" for="email">Email:
            <input class="p-3 rounded-lg text-gray-900" type="email" name="email" v-model="email"
              placeholder="please enter you email" required>
          </label>

          <label class="flex flex-col text-white font-bold text-lg" for="phone">Phone Number:
            <input class="p-3 rounded-lg text-gray-900" type="text" name="phone" v-model="phoneNumber"
              placeholder="please enter you phone number">
          </label>

          <label class="flex flex-col text-white font-bold text-lg" for="message">Your Message:
            <textarea class="rounded-lg text-gray-900 p-2" name="message" id="message" v-model="message" cols="30"
              rows="5" placeholder="your message"></textarea>
          </label>

          <div class="flex flex-col justify-center items-center mt-5 w-full">
            <button
              class="btn p-4 text-center text-blue-600 bg-white border hover:bg-blue-100 hover:border-white hover:text-blue-900 border-blue-900 rounded-xl font-bold w-full lg:w-6/12">Submit</button>
          </div>
        </form>
      </div>
      <!-- success message -->
      <div class="flex flex-col justify-center w-full lg:w-4/12" v-if="success">
        ...
        <img src="../assets/Checkmark-green-tick-isolated-on-transparent-background-PNG.png" class="mx-auto" width="200"
          height="200" alt="">
      ...
      <div class="w-full lg:w-6/12 px-2">
        ...
        <p class="my-2 text0-lg">Give us a call on the above number and we'd be delighted to answer any of your
          questions.</p>
        <p class="font-bold text-xl my-2">+447539294710</p>
        <p class="my-2 text-lg">Alternatively you can send us a message on WhatsApp. Please ensure to include your name
          and reason for messaging.</p>
        <div class="mt-6">
          <h2 class="text-center font-bold mb-4 text-xl">Or come on down to our next event and meet the team</h2>
          <div class="flex justify-center">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d9482.742113990602!2d-2.6303!3d53.545529!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x37fbc44593c758a9!2sWigan%20Library!5e0!3m2!1sen!2suk!4v1669138271335!5m2!1sen!2suk"
              class="w-full" width="600" height="350" style="border:0;" allowfullscreen="" loading="lazy"
